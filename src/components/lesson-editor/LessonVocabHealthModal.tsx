 ...
 * 
 * Scans all words in the lesson and shows vocabulary health status.
 * Allows quick-fixing: generate audio, AI tag, add to vocab, etc.
 */
...
import { VocabularyEditorSlideOver } from './VocabularyEditorSlideOver';

interface LessonVocabHealthModalProps {
  isOpen: boolean;
  onClose: () => void;
  blocks: ContentBlock[];
  lessonId?: string;
...
export function LessonVocabHealthModal({
  isOpen,
  onClose,
  blocks,
}: LessonVocabHealthModalProps) {
    ...
    <>
      ...
      <div className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[700px] md:max-h-[80vh] bg-white rounded-xl shadow-2xl z-50 flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <div>
            <h2 className="text-lg font-semibold">Lesson Vocabulary Health</h2>
            <p className="text-sm text-gray-500">
              {healthData?.summary.total || 0} unique words found in this lesson
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500">Scanning lesson words...</p>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">No Chinese words found in this lesson</p>
            </div>
          ) : (
            <>
              {/* Summary Bar */}
...
export default LessonVocabHealthModal;
